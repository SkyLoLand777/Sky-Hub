...
function DiscordLib:Notification(titel, text, delays)
    ...
    -- Função para alterar a cor gradualmente
    local function ChangeColor()
        while true do
            TitleFrame.BackgroundColor3 = Color3.fromHSV(tick() % 5 / 5, 1, 1) -- Altera a cor usando o espaço de cor HSV
            wait(0.1) -- Aguarda um curto período de tempo antes de mudar para a próxima cor
        end
    end

    spawn(ChangeColor) -- Inicia a função em uma nova thread
...
--------------------------------------------------------------------
local Library = Update:Window("SKY HUB","")
------------------------------------------
...
Setting:Label("Entre Na Comunidade Discord.gg/skyland")
...
Main:Seperator("  @The.skyland no tiktok 🇧🇷")
...
Main:Seperator(" Ilha Da Miragem 🏝️ | SkyLand |")
...
wait(1)
Notification:Notify(
   {Title = "Sky Hub", Description = "You Have Max Observation"},
...
Weapon:Seperator(" Missões📜 | SkyLand |")
...
spawn(function()
 ...
 DevilFruit:Seperator(" outros | SkyLand |  ")
